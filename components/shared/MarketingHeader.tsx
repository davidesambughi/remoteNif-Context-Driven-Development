  ...
  return (
    <header className="sticky top-0 z-50 bg-[var(--bg-surface)] border-b border-[var(--border-subtle)]">
      <div className="max-w-7xl mx-auto px-4 h-14 flex items-center justify-between">
        <Link
          href="/"
          className="font-semibold text-[length:var(--text-base)] text-[var(--text-primary)] hover:opacity-80 transition-[var(--transition-base)]"
        >
          RemoteNIF
        </Link>
        ...
        <div className="flex items-center gap-[length:var(--space-4)]">
          ...
          <Link
            href="/signin"
            className="text-sm font-[number:var(--font-medium)] text-[var(--text-primary)]
